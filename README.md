...
**Author**: Heilongv · **Version**: 1.2.1 · **Free forever**
...
### v1.2.1 (2026-08-17)
- Stability fixes: remote memory release after disconnect, power lock rollback, dynamic base-relative shellcode jumps, Toolhelp process detection, dead code cleanup
